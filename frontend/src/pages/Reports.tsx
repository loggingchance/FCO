  ...
  return (
    <section className="document-page">
      ...
      <article className="report-preview">
        ...
        <div className="report-columns"><span>Total carbon: 1.28B metric tonnes</span><span>Forest area: 17.1M acres</span><span>Standard error: 61.4M metric tonnes</span><span>Sampling error: 4.8%</span><span>Contributing plots: reported with live FIA results</span></div>
